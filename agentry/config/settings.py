...
try:
    ...
    _toml_path = Path(__file__).parent.parent.parent / "agentry.toml"
...
class AgentrySettings:
    """
    Centralized configuration for Agentry.
    ...
    def LANCEDB_PATH(self) -> str:
        ...
        return str(self.BASE_DIR / "agentry" / "user_data" / "lancedb_data")
    ...
    # KUBERNETES / AZURE (for deployment)
    # ==========================================================================
    ACR_REGISTRY: str = field(default_factory=lambda: _get_env("ACR_REGISTRY", "agentryacr.azurecr.io", "kubernetes", "acr_registry"))
    AKS_CLUSTER: str = field(default_factory=lambda: _get_env("AKS_CLUSTER", "agentry-aks", "kubernetes", "aks_cluster"))
    AKS_RESOURCE_GROUP: str = field(default_factory=lambda: _get_env("AKS_RESOURCE_GROUP", "agentry-rg", "kubernetes", "aks_resource_group"))
